...
class NEMO96HDLe(Device):

    def __init__(self, custom_name, device_address, port):
        super().__init__(custom_name, device_address, "NEMO96HDLe", port, 9600, 8, "N", 1)
    ...
    def read_all_properties(self):
        """
        Read all parameters from NEMO96HDLe
    ...
    def read_one_property_register(self, parameter: str):
        """
        Read one parameter from NEMO96HDLe
